...
export default function App() {
  ...
  return (
    <div className="container">
      <ChangeCity gettingWeather={gettingWeather} gettingWeeklyWeather={gettingWeeklyWeather} />
      <WeatherToday infoCity={infoCity} errorSearch={errorSearch} />
      <MoreInfo moreInfo={moreInfo} enabledBtn={enabledBtn} errorSearch={errorSearch} />
    </div>
  );
}
